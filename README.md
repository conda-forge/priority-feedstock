...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/priority-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5963&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/priority-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `priority` can be installed with:

```
conda install priority
```

It is possible to list all of the versions of `priority` available on your platform with:
